...
public:
  ...
  //! Cheks if surface theS1 has degenerated boundary (dS/du or dS/dv = 0) and
  //! calculates minimal distance between corresponding singular points and surface theS2
  //! If singular point exist method returns "true" and stores minimal distance in theDist
  ...
  Standard_EXPORT static Standard_Real RecUVMaxStep(
    const Handle(Adaptor3d_Surface)&  theS1,
    const Handle(Adaptor3d_TopolTool)& theD1,
    const Handle(Adaptor3d_Surface)&  theS2,
