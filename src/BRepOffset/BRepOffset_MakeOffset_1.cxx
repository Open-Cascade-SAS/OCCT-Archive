                                                       ...
                                                       BRepAlgo_Image& theImage)
{
  ...
  if (anInvFaces.Extent()) {
    ...
    if (aFToRebuild.Extent()) {
      ...
      RebuildFaces(aFToRebuild, aFSelfRebAvoid, aSolids, aIntRes, aFImages, aDMFNewHoles,
                           ...
                           Handle(BRepAlgo_AsDes)& theAsDes)
{
  ...
  if (anInvFaces.Extent()) {
    ...
    //
    if (aFToRebuild.Extent()) {
      RebuildFaces(aFToRebuild, aFSelfRebAvoid, aSolids, aIntRes, theFImages, theDMFNewHoles,
