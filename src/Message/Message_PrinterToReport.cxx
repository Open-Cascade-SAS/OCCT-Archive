                                                ...
                                                const Message_Gravity   theGravity) const
{
  ...
  else
  {
    if (!myName.IsEmpty())
    {
      ...
      myName.Clear();
      Send (aName, theGravity, Standard_True);
    }
...
//purpose  :
//=======================================================================
void Message_PrinterToReport::Send (const TCollection_ExtendedString& theString, const Message_Gravity theGravity, const Standard_Boolean theToPutEol) const
{
  if (!myName.IsEmpty())
  {
    Send (myName, theGravity, theToPutEol);
    myName.Clear();
  }
